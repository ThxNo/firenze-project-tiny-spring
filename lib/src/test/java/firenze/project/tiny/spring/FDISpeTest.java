...
import firenze.project.tiny.spring.example.AEngine;
import firenze.project.tiny.spring.example.Engine;
import firenze.project.tiny.spring.example.MyContainerConfig;
...
public class FDISpeTest {
    ...
    public void initContainer() {
        ContainerConfig containerConfig = new MyContainerConfig();
